...
func newEmbedder(client *genai.Client, name string, embedOpts *ai.EmbedderOptions) *ai.EmbedderAction {
	...
	return ai.NewTypedEmbedder(api.NewName(provider, name), embedOpts, func(ctx context.Context, req *ai.EmbedRequest, embedConfig genai.EmbedContentConfig) (*ai.EmbedResponse, error) {
